...
namespace ucenio { namespace example_plugin {

class hello_api_plugin : public ucenio::app::plugin
{
   public:
      /**
       ...
       */
      hello_api_plugin( ucenio::app::application* app );
...
{
   public:
      hello_api_api( const ucenio::app::api_context& ctx );
...
FC_API( ucenio::example_plugin::hello_api_api,
   (get_message)
   )

namespace ucenio { namespace example_plugin {

hello_api_plugin::hello_api_plugin( ucenio::app::application* app ) : ucenio::app::plugin(app) {}
...
hello_api_api::hello_api_api( const ucenio::app::api_context& ctx ) : _app(ctx.app) {}
...
/**
 * The STEEMIT_DEFINE_PLUGIN() macro will define a ucenio::plugin::create_hello_api_plugin()
 * factory method which is expected by the manifest.
 */

STEEMIT_DEFINE_PLUGIN( hello_api, ucenio::example_plugin::hello_api_plugin )
