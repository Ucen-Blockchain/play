...
int main(int argc, char** argv) {
   ucenio::plugin::initialize_plugin_factories();
   ...
   try {
      ...
      for( const std::string& plugin_name : ucenio::plugin::get_available_plugins() )
         node->register_abstract_plugin( ucenio::plugin::create_plugin( plugin_name, node ) );
