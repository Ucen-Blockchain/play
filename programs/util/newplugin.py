...
{{
   public:
      {plugin_name}_api( const ucenio::app::api_context& ctx );
...
class {plugin_name}_plugin : public ucenio::app::plugin
{{
   public:
      {plugin_name}_plugin( ucenio::app::application* app );
...
{{
   public:
      {plugin_name}_api_impl( ucenio::app::application& _app );
...
{plugin_name}_api_impl::{plugin_name}_api_impl( ucenio::app::application& _app ) : app( _app )
{{}}
...
{plugin_name}_api::{plugin_name}_api( const ucenio::app::api_context& ctx )
{{
...
{{
   public:
      {plugin_name}_plugin_impl( ucenio::app::application& app );
...
{plugin_name}_plugin_impl::{plugin_name}_plugin_impl( ucenio::app::application& app )
  : _app(app) {{}}
...
{plugin_name}_plugin::{plugin_name}_plugin( ucenio::app::application* app )
   : plugin(app)
{{
...
def main(argv):
    ...
    parser.add_argument("provider", help="Name of plugin provider (ucenio for plugins developed by Steemit)")
