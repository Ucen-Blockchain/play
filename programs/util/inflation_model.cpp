...
using ucenio::protocol::calc_percent_reward_per_block;
using ucenio::protocol::calc_percent_reward_per_round;
using ucenio::protocol::calc_percent_reward_per_hour;
