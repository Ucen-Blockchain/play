...
FC_REFLECT( ucenio::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( ucenio::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( ucenio::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( ucenio::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( ucenio::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( ucenio::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( ucenio::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( ucenio::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( ucenio::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( ucenio::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( ucenio::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( ucenio::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( ucenio::protocol::chain_properties, (account_creation_fee)(maximum_block_size)(sbd_interest_rate) );

FC_REFLECT_TYPENAME( ucenio::protocol::pow2_work )
FC_REFLECT( ucenio::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( ucenio::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( ucenio::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( ucenio::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( ucenio ::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( ucenio::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( ucenio::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( ucenio::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( ucenio::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( ucenio::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( ucenio::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( ucenio::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( ucenio::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( ucenio::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( ucenio::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( ucenio::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( ucenio::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( ucenio::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( ucenio::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( ucenio::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( ucenio::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( ucenio::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( ucenio::protocol::comment_payout_beneficiaries, (beneficiaries) )
FC_REFLECT_TYPENAME( ucenio::protocol::comment_options_extension )
FC_REFLECT( ucenio::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_steem_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( ucenio::protocol::escrow_transfer_operation, (from)(to)(sbd_amount)(steem_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( ucenio::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( ucenio::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( ucenio::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(sbd_amount)(steem_amount) );
FC_REFLECT( ucenio::protocol::challenge_authority_operation, (challenger)(challenged)(require_owner) );
FC_REFLECT( ucenio::protocol::prove_authority_operation, (challenged)(require_owner) );
FC_REFLECT( ucenio::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( ucenio::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( ucenio::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( ucenio::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT( ucenio::protocol::claim_reward_balance_operation, (account)(reward_steem)(reward_sbd)(reward_vests) )
FC_REFLECT( ucenio::protocol::delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
