...
} } // namespace ucenio::protocol


FC_REFLECT_TYPENAME( ucenio::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( ucenio::protocol::authority::key_authority_map)
FC_REFLECT( ucenio::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( ucenio::protocol::authority::classification, (owner)(active)(key)(posting) )
