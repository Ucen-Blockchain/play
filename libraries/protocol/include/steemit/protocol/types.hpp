...
namespace ucenio {
   ...
   namespace protocol {
      ...
      #define STEEMIT_INIT_PUBLIC_KEY (ucenio::protocol::public_key_type(STEEMIT_INIT_PUBLIC_KEY_STR))
...
FC_REFLECT( ucenio::protocol::public_key_type, (key_data) )
FC_REFLECT( ucenio::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( ucenio::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( ucenio::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( ucenio::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( ucenio::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( ucenio::protocol::share_type )

FC_REFLECT( ucenio::void_t, )
