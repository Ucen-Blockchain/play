...
#include <ucenio/wallet/api_documentation.hpp>
#include <ucenio/wallet/reflect_util.hpp>

#include <ucenio/account_by_key/account_by_key_api.hpp>
...
namespace ucenio { namespace wallet {
...
public:
   ...
   bool import_key(string wif_key)
   {
      ...
      ucenio::chain::public_key_type wif_pub_key = optional_private_key->get_public_key();
   ...
   int find_first_unused_derived_key_index(const fc::ecc::private_key& parent_key)
   {
      ...
      for (int key_index = 0; ; ++key_index)
      {
         ...
         ucenio::chain::public_key_type derived_public_key = derived_private_key.get_public_key();
   ...
   { try {
         ...
         ucenio::chain::public_key_type owner_pubkey = owner_privkey.get_public_key();
         ucenio::chain::public_key_type active_pubkey = active_privkey.get_public_key();
         ucenio::chain::public_key_type memo_pubkey = memo_privkey.get_public_key();
