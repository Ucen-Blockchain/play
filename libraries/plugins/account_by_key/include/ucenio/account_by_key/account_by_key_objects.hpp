...
FC_REFLECT( ucenio::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( ucenio::account_by_key::key_lookup_object, ucenio::account_by_key::key_lookup_index )
