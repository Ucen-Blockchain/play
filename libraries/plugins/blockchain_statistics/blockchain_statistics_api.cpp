#include <ucenio/blockchain_statistics/blockchain_statistics_api.hpp>
...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( ucenio::app::application& app )
            :_app( app ) {}
...
blockchain_statistics_api::blockchain_statistics_api( const ucenio::app::api_context& ctx )
{
