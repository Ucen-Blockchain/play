...
#include <ucenio/plugins/raw_block/raw_block_api.hpp>
#include <ucenio/plugins/raw_block/raw_block_plugin.hpp>
...
{
   public:
      raw_block_api_impl( ucenio::app::application& _app );

      std::shared_ptr< ucenio::plugin::raw_block::raw_block_plugin > get_plugin();

      ucenio::app::application& app;
};

raw_block_api_impl::raw_block_api_impl( ucenio::app::application& _app ) : app( _app )
{}

std::shared_ptr< ucenio::plugin::raw_block::raw_block_plugin > raw_block_api_impl::get_plugin()
{
...
raw_block_api::raw_block_api( const ucenio::app::api_context& ctx )
{
...
get_raw_block_result raw_block_api::get_raw_block( get_raw_block_args args )
{
   ...
   std::shared_ptr< ucenio::chain::database > db = my->app.chain_database();
