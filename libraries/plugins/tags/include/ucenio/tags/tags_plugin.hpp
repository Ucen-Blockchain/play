...
namespace ucenio { namespace tags {
 ...
 *
 */
class tags_plugin : public ucenio::app::plugin
{
   public:
...
FC_API( ucenio::tags::tag_api, (get_tags) );

FC_REFLECT( ucenio::tags::tag_object,
   (id)(tag)(created)(active)(cashout)(net_rshares)(net_votes)(hot)(trending)(promoted_balance)(children)(author)(parent)(comment) )
CHAINBASE_SET_INDEX_TYPE( ucenio::tags::tag_object, ucenio::tags::tag_index )

FC_REFLECT( ucenio::tags::tag_stats_object,
   (id)(tag)(total_payout)(net_votes)(top_posts)(comments)(total_trending) );
CHAINBASE_SET_INDEX_TYPE( ucenio::tags::tag_stats_object, ucenio::tags::tag_stats_index )

FC_REFLECT( ucenio::tags::peer_stats_object,
   (id)(voter)(peer)(direct_positive_votes)(direct_votes)(indirect_positive_votes)(indirect_votes)(rank) );
CHAINBASE_SET_INDEX_TYPE( ucenio::tags::peer_stats_object, ucenio::tags::peer_stats_index )

FC_REFLECT( ucenio::tags::comment_metadata, (tags) );

FC_REFLECT( ucenio::tags::author_tag_stats_object, (id)(author)(tag)(total_posts)(total_rewards) )
CHAINBASE_SET_INDEX_TYPE( ucenio::tags::author_tag_stats_object, ucenio::tags::author_tag_stats_index )
