...
FC_REFLECT( ucenio::witness::enable_content_editing_operation, (account)(relock_time) )

FC_REFLECT_TYPENAME( ucenio::witness::witness_plugin_operation )

DECLARE_OPERATION_TYPE( ucenio::witness::witness_plugin_operation )
