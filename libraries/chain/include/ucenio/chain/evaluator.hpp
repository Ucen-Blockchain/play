...
template< typename OperationType=ucenio::protocol::operation >
class evaluator
{
   public:
...
template< typename EvaluatorType, typename OperationType=ucenio::protocol::operation >
...
class X ## _evaluator : public ucenio::chain::evaluator_impl< X ## _evaluator > \
{                                                                           \
   public:                                                                  \
      typedef X ## _operation operation_type;                               \
                                                                            \
      X ## _evaluator( database& db )                                       \
         : ucenio::chain::evaluator_impl< X ## _evaluator >( db )          \
      {}                                                                    \
                                                                            \
