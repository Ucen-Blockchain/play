...
#include <ucenio/chain/shared_authority.hpp>
...
FC_REFLECT( ucenio::chain::account_object,
...
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::account_object, ucenio::chain::account_index )

FC_REFLECT( ucenio::chain::account_authority_object,
             (id)(account)(owner)(active)(posting)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::account_authority_object, ucenio::chain::account_authority_index )

FC_REFLECT( ucenio::chain::vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::vesting_delegation_object, ucenio::chain::vesting_delegation_index )

FC_REFLECT( ucenio::chain::vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::vesting_delegation_expiration_object, ucenio::chain::vesting_delegation_expiration_index )

FC_REFLECT( ucenio::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::owner_authority_history_object, ucenio::chain::owner_authority_history_index )

FC_REFLECT( ucenio::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::account_recovery_request_object, ucenio::chain::account_recovery_request_index )

FC_REFLECT( ucenio::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::change_recovery_account_request_object, ucenio::chain::change_recovery_account_request_index )
