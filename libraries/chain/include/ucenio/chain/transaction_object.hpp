...
FC_REFLECT( ucenio::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::transaction_object, ucenio::chain::transaction_index )
