...
FC_REFLECT_ENUM( ucenio::chain::curve_id,
                  (quadratic)(quadratic_curation)(linear)(square_root))

FC_REFLECT( ucenio::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::limit_order_object, ucenio::chain::limit_order_index )

FC_REFLECT( ucenio::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::feed_history_object, ucenio::chain::feed_history_index )

FC_REFLECT( ucenio::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::convert_request_object, ucenio::chain::convert_request_index )

FC_REFLECT( ucenio::chain::liquidity_reward_balance_object,
             (id)(owner)(steem_volume)(sbd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::liquidity_reward_balance_object, ucenio::chain::liquidity_reward_balance_index )

FC_REFLECT( ucenio::chain::withdraw_vesting_route_object,
             (id)(from_account)(to_account)(percent)(auto_vest) )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::withdraw_vesting_route_object, ucenio::chain::withdraw_vesting_route_index )

FC_REFLECT( ucenio::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::savings_withdraw_object, ucenio::chain::savings_withdraw_index )

FC_REFLECT( ucenio::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (sbd_balance)(steem_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::escrow_object, ucenio::chain::escrow_index )

FC_REFLECT( ucenio::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::decline_voting_rights_request_object, ucenio::chain::decline_voting_rights_request_index )

FC_REFLECT( ucenio::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::reward_fund_object, ucenio::chain::reward_fund_index )
