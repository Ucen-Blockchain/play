...
FC_REFLECT( ucenio::chain::operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::operation_object, ucenio::chain::operation_index )

FC_REFLECT( ucenio::chain::account_history_object, (id)(account)(sequence)(op) )
CHAINBASE_SET_INDEX_TYPE( ucenio::chain::account_history_object, ucenio::chain::account_history_index )
