...
namespace ucenio { namespace chain {
   ...
   using ucenio::protocol::weight_type;
...
FC_REFLECT_TYPENAME( ucenio::chain::shared_authority::account_authority_map)
FC_REFLECT( ucenio::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
