...
#include <ucenio/tags/tags_plugin.hpp>

#include <ucenio/follow/follow_plugin.hpp>
#include <ucenio/witness/witness_plugin.hpp>
...
{
   price                order_price;
   double               real_price; // dollars per ucen
   share_type           steem;
   share_type           sbd;
...
{
   public:
      database_api(const ucenio::app::api_context& ctx);
      ~database_api();
...
FC_REFLECT( ucenio::app::order, (order_price)(real_price)(steem)(sbd)(created) );
FC_REFLECT( ucenio::app::order_book, (asks)(bids) );
FC_REFLECT( ucenio::app::scheduled_hardfork, (hf_version)(live_time) );
FC_REFLECT( ucenio::app::liquidity_balance, (account)(weight) );
FC_REFLECT( ucenio::app::withdraw_route, (from_account)(to_account)(percent)(auto_vest) );

FC_REFLECT( ucenio::app::discussion_query, (tag)(filter_tags)(select_tags)(select_authors)(truncate_body)(start_author)(start_permlink)(parent_author)(parent_permlink)(limit) );

FC_REFLECT_ENUM( ucenio::app::withdraw_route_type, (incoming)(outgoing)(all) );

FC_API(ucenio::app::database_api,
   // Subscriptions
