#pragma once
#include <ucenio/app/applied_operation.hpp>
#include <ucenio/app/steem_api_objects.hpp>
...
FC_REFLECT_DERIVED( ucenio::app::extended_account,
                   (ucenio::app::account_api_obj),
...
FC_REFLECT( ucenio::app::vote_state, (voter)(weight)(rshares)(percent)(reputation)(time) );
FC_REFLECT( ucenio::app::account_vote, (authorperm)(weight)(rshares)(percent)(time) );

FC_REFLECT( ucenio::app::discussion_index, (category)(trending)(payout)(payout_comments)(trending30)(updated)(created)(responses)(active)(votes)(maturing)(best)(hot)(promoted)(cashout) )
FC_REFLECT( ucenio::app::tag_index, (trending) )
FC_REFLECT_DERIVED( ucenio::app::discussion, (ucenio::app::comment_api_obj), (url)(root_title)(pending_payout_value)(total_pending_payout_value)(active_votes)(replies)(author_reputation)(promoted)(body_length)(reblogged_by)(first_reblogged_by)(first_reblogged_on) )

FC_REFLECT( ucenio::app::state, (current_route)(props)(tag_idx)(tags)(content)(accounts)(pow_queue)(witnesses)(discussion_idx)(witness_schedule)(feed_price)(error)(market_data) )

FC_REFLECT_DERIVED( ucenio::app::extended_limit_order, (ucenio::app::limit_order_api_obj), (real_price)(rewarded) )
FC_REFLECT( ucenio::app::order_history_item, (time)(type)(sbd_quantity)(steem_quantity)(real_price) );
FC_REFLECT( ucenio::app::market, (bids)(asks)(history)(price_history)(available_candlesticks)(available_zoom)(current_candlestick)(current_zoom) )
FC_REFLECT( ucenio::app::candle_stick, (open_time)(period)(high)(low)(open)(close)(steem_volume)(dollar_volume) );
