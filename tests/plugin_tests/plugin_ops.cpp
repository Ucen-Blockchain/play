...
using namespace ucenio::chain::test;
/*
namespace ucenio { namespace plugin_tests {
...
STEEMIT_DEFINE_PLUGIN( test, ucenio::plugin_tests::test_plugin )

FC_REFLECT( ucenio::plugin_tests::test_a_operation, (account) )
FC_REFLECT( ucenio::plugin_tests::test_b_operation, (account) )

DECLARE_OPERATION_TYPE( ucenio::plugin_tests::test_op );
FC_REFLECT_TYPENAME( ucenio::plugin_tests::test_op );
DEFINE_OPERATION_TYPE( ucenio::plugin_tests::test_op );
*/
